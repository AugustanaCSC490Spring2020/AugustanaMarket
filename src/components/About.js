...
const About = () => {
    return (
        <div>
            <h1>Simplicity			Innovation				Exclusivity</h1>
            <p1>These are the three main principles that we, Team Quail, wanted to embody in the Augustana Marketplace. 
                When beginning the project, Team Quail was just a group of four Augustana students who recognized a problem,
                 ...
                 Unfortunately, these methods were both inconvenient and costly for cash-strapped college students.
                  Throughout our creation process, we kept these students in mind and attempted to make an app that is user-friendly 
                  ...
                  With that, we hope this app helps the Augustana community. Go Vikings!</p1>
                  <h2>Meet Team Quail</h2>
        </div>
    )
}
