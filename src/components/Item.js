...
const Item = ({match}) => {
                        ...
                        <div className="row">
                            ...
                            {selectedItem.item.uid !== firebase.auth().currentUser.uid ?
                                <button onClick={liked ? removeFromFavorites : addToFavorites} className={"border rounded-circle outline-none border-grey"}>
                                    <div className={"px-1 py-1"}>{liked ? <h4 className={"m-0 pt-small"}><i className="fa fa-heart color-red"></i></h4>
                                        : <h4 className={"m-0 pt-small"}><i className="fa fa-heart-o" aria-hidden="true"></i></h4>}
                                    </div>
                                </button> : null}
                            </div>
                        </div>
 ...
 div                            <h4>Price: ${selectedItem.item.price}</h4>
